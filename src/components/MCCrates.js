...
const initialState = {
    formData: {
        price: {
            ...
            options: [
                { value: 0.65, display: 'Common (1.00 EUR)' },
                { value: 1.35, display: 'Epic (1.50 EUR)' },
                { value: 3.25, display: 'Legendary (2.00 EUR)' }
            ],
            value: 0,
...
class MCCrates extends React.Component {
    state = {
        ...initialState
    }
    ...
    handleSuccess() {
        /*this.props.sendSuccessData("donate", {
            ...
            crateType: this.state.formData.price.value,
...
export default connect(mapStateToProps, mapDispatchToProps)(MCCrates)